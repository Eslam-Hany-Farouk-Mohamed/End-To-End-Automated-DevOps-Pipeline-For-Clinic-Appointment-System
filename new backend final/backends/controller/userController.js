...
// POST /api/v1/user/login   (+ /admin/login, /patient/login)
export const login = catchAsyncErrors(async (req, res, next) => {
  // ✅ Accept several possible field names from dashboard/frontend
  const emailRaw =
    req.body.email ||
    req.body.adminEmail ||
    req.body.username ||
...
// ⬇️ keep the rest of the file exactly as you already have it:
// patientRegister, getUserDetails, logoutAdmin, logoutPatient,
// addNewAdmin, getAllDoctors, addNewDoctor...
